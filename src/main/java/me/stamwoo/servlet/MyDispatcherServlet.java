...
public class MyDispatcherServlet extends HttpServlet {
    ...
    private void doDispatch(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        //利用反射机制来调用
        try {
            method.invoke(this.controllerMap.get(requestURI), paramValues);//obj是method所对应的实例 在ioc容器中
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
